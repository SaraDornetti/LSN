...
public: // Function declarations
  ...
  void new_generation(Random& _rnd);      // parte dalla generazione attuale e implementa crossover/mutazioni
  ...
  void mean_fitness(); //in cui calcolo la media dei fitness a ogni generazione e salvo in un file --> apri file in initialize()
